"""PressureFit policy: initial placement, inbound-schedule candidates, and triggers.
...
- test_pressurefit_evaluates_exactly_four_inbound_schedules: the four named inbound-schedule candidates are enumerated and the selected makespan is the minimum over the valid ones.
