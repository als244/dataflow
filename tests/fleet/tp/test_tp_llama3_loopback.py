"""llama3-TP (MLP tensor parallelism through the sharding
...
Tests:
- test_tp_llama3_two_daemons_vs_plain: MLP tensor parallelism over two daemons yields bitwise-equal per-step losses across ranks, replicated W fields bitwise identical while the MLP shard fields (w1/w3/w2) differ, a worst loss gap under 2e-2 versus a plain single-daemon run, and per-rank W_0/O_0 smaller than plain.
"""
import threading
import time
