"""P1 gates: two REAL daemons on this box exchanging objects through
the full stack — NM threads, locked allocator, zero-copy landing,
queued catalog commits, verbs, events. Opt-in lane (pytest -m fleet)."""
import threading
import time
