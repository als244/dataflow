...
dataflow.models.qwen3moe_reference): the example is self-contained client
...
(GoldenLlama3 and GoldenOlmoe, formerly dataflow.models.llama3_reference
and dataflow.models.olmoe_reference).
...
class GoldenQwen3Moe(GoldenOlmoe):
    """Golden Qwen3-MoE reference. Same contract as GoldenOlmoe (whose
    CE+aux objective / CE-only reported loss and AdamW replica are
