...
dsa_topk_reference at its single true site (blocks.modules.dsa_forms — the goldens' selection helper calls through it); routing via the
...
def _refs():
    import dataflow_training.blocks.modules.dsa_forms as dref
    import dataflow_training.blocks.modules.moe.forms as mref
