...
| [pressurefit.md](pressurefit.md) | Pressure-fit interval portfolio; fastest simulator-verified `CutScore`/`PrefetchRule` candidate | General chains needing fast planning | Cases needing proactive global to-slow packing |
...
PressureFit changes should also run the reproducible cross-version gate in
[pressurefit-quality.md](pressurefit-quality.md).

For a compact, paper-oriented algorithm followed by an architectural diagram
and source-level module map, see
