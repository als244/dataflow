# gpt2 / `tiny_tied` @ 16x4K: tasks, objects, kernels

GENERATED from `ShapedGpt2Config.tiny_tied()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset tiny_tied --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
| `W_embed` | run | 576.50 KiB |
| `O_embed` | run | 1.13 MiB |
...
|---|---|---|
| W (all weights, incl. embed/head) | 3 | 725.50 KiB |
| dW (all gradients, per step) | 3 | 725.50 KiB |
| O (all optimizer state) | 3 | 1.42 MiB |
...
- inputs: `tokens_0_0` (256.00 KiB), `W_embed` (576.50 KiB)
...
- inputs: `y_0_0_1` (8.00 MiB), `targets_0_0` (256.00 KiB), `W_embed` (576.50 KiB)
- outputs: `dy_0_0_1` (8.00 MiB), `loss_0_0` (4 B), `dW_embed_0` (576.50 KiB)
- mutates: —
- kernel calls:
    0. `layernorm_fwd`
    1. `mm`
...
- inputs: `dy_embed_0_0` (8.00 MiB), `tokens_0_0` (256.00 KiB), `dW_embed_0` (576.50 KiB)
- outputs: —
- mutates: `dW_embed_0`
- kernel calls:
    0. `embed_bwd_accum ×2`
...
- inputs: `W_embed` (576.50 KiB), `dW_embed_0` (576.50 KiB), `O_embed` (1.13 MiB)
- outputs: —
