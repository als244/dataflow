# gpt2 / `tiny_nobias` @ 16x4K: tasks, objects, kernels

GENERATED from `ShapedGpt2Config.tiny_nobias()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset tiny_nobias --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
| object | scope | size |
|---|---|---|
| `W_i (block)` | layer | 72.50 KiB |
| `dW_i (block)` | layer/step | 72.50 KiB |
| `O_i (block)` | layer | 145.00 KiB |
...
|---|---|---|
| W (all weights, incl. embed/head) | 4 | 785.25 KiB |
| dW (all gradients, per step) | 4 | 785.25 KiB |
| O (all optimizer state) | 4 | 1.53 MiB |
...
- inputs: `y_embed_0_0` (8.00 MiB), `W_0` (72.50 KiB)
...
- inputs: `dy_0_0_1` (8.00 MiB), `A_0_0_1` (62.00 MiB), `y_0_0_0` (8.00 MiB), `W_1` (72.50 KiB)
- outputs: `dy_0_0_0` (8.00 MiB), `dW_0_1` (72.50 KiB)
- mutates: —
- kernel calls:
    0. `layernorm_apply`
    1. `gelu_fwd_out`
...
- inputs: `W_1` (72.50 KiB), `dW_0_1` (72.50 KiB), `O_1` (145.00 KiB)
- outputs: —
- mutates: `W_1`, `O_1`
- kernel calls:
    0. `adamw_step ×12`
