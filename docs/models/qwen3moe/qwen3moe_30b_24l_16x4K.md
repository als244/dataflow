...
GENERATED from `ShapedQwen3MoeConfig.qwen3moe_30b_24l()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset qwen3moe_30b_24l --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
|---|---|---|
| W (all weights, incl. embed/head) | 26 | 29.01 GiB |
| dW (all gradients, per step) | 26 | 29.01 GiB |
| O (all optimizer state) | 26 | 58.03 GiB |
| A (all saved activations, one round) | 24 | 69.79 GiB (1.09 MiB/token) |
| M (all metadata, one round) | 24 | 120.02 MiB (1.88 KiB/token) |
...
- inputs: `Aux_0` (1.50 KiB), `Aux_1` (1.50 KiB), `Aux_2` (1.50 KiB), `Aux_3` (1.50 KiB), `Aux_4` (1.50 KiB), `Aux_5` (1.50 KiB), `Aux_6` (1.50 KiB), `Aux_7` (1.50 KiB), `Aux_8` (1.50 KiB), `Aux_9` (1.50 KiB), `Aux_10` (1.50 KiB), `Aux_11` (1.50 KiB), `Aux_12` (1.50 KiB), `Aux_13` (1.50 KiB), `Aux_14` (1.50 KiB), `Aux_15` (1.50 KiB), `Aux_16` (1.50 KiB), `Aux_17` (1.50 KiB), `Aux_18` (1.50 KiB), `Aux_19` (1.50 KiB), `Aux_20` (1.50 KiB), `Aux_21` (1.50 KiB), `Aux_22` (1.50 KiB), `Aux_23` (1.50 KiB)
- outputs: `current_round_0_0` (4 B)
- mutates: `Aux_0`, `Aux_1`, `Aux_2`, `Aux_3`, `Aux_4`, `Aux_5`, `Aux_6`, `Aux_7`, `Aux_8`, `Aux_9`, `Aux_10`, `Aux_11`, `Aux_12`, `Aux_13`, `Aux_14`, `Aux_15`, `Aux_16`, `Aux_17`, `Aux_18`, `Aux_19`, `Aux_20`, `Aux_21`, `Aux_22`, `Aux_23`
...
- inputs: `y_0_0_23` (256.00 MiB), `targets_0_0` (256.00 KiB), `W_head` (593.50 MiB)
- outputs: `dy_0_0_23` (256.00 MiB), `loss_0_0` (4 B), `dW_head_0` (593.50 MiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_fwd`
    1. `mm`
...
- inputs: `dy_0_0_23` (256.00 MiB), `A_0_0_23` (2.91 GiB), `y_0_0_22` (256.00 MiB), `W_23` (1.16 GiB), `AuxTemp_0_0_23` (5.00 MiB), `Aux_23` (1.50 KiB)
- outputs: `dy_0_0_22` (256.00 MiB), `dW_0_23` (1.16 GiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_apply`
...
- inputs: `W_23` (1.16 GiB), `dW_0_23` (1.16 GiB), `O_23` (2.32 GiB)
- outputs: —
- mutates: `W_23`, `O_23`
- kernel calls:
    0. `adamw_step ×11`
