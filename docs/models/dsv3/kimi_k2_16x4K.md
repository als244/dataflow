# dsv3 / `kimi_k2` @ 16x4K: tasks, objects, kernels

GENERATED from `ShapedDsv3Config.kimi_k2()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_page.py --preset kimi_k2 --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
| dW (all gradients, per step) | 63 | 2,052,816,510,976 |
| O (all optimizer state) | 63 | 4,105,633,021,952 |
| A (all saved activations, one round) | 61 | 438,544,891,904 (6,691,664.0/token) |
