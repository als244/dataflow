...
GENERATED from `ShapedDsv3Config.dsv3_671b()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset dsv3_671b --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
- inputs: `y_0_0_2` (896.00 MiB), `W_3` (21.43 GiB), `current_round_0_0` (4 B), `Aux_3` (3.00 KiB)
- outputs: `y_0_0_3` (896.00 MiB), `A_0_0_3` (7.70 GiB), `AuxTemp_0_0_3` (5.00 MiB)
- mutates: `Aux_3`
- stages (name — emitted ctx fields):
    0. `attn_norm` — rstd_attn
    1. `mla_q` — q_a, rstd_qa
...
- inputs: `dy_0_0_60` (896.00 MiB), `A_0_0_60` (7.70 GiB), `y_0_0_59` (896.00 MiB), `W_60` (21.43 GiB), `AuxTemp_0_0_60` (5.00 MiB), `Aux_60` (3.00 KiB)
