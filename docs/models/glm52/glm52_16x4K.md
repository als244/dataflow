...
GENERATED from `ShapedGlm52Config.glm52()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset glm52 --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
| object | scope | size |
|---|---|---|
| `W_i (gdl)` | layer | 765.03 MiB |
| `dW_i (gdl)` | layer/step | 765.03 MiB |
| `O_i (gdl)` | layer | 1.49 GiB |
| `A (gdl)` | layer × round | 6.09 GiB (97.39 KiB/token) |
| `M (gdl)` | layer × round | 512.00 MiB (8.00 KiB/token) |
| `W_i (gmf)` | layer | 18.38 GiB |
| `dW_i (gmf)` | layer/step | 18.38 GiB |
| `O_i (gmf)` | layer | 36.76 GiB |
| `A (gmf)` | layer × round | 7.62 GiB (121.89 KiB/token) |
| `M (gmf)` | layer × round | 5.00 MiB (80.0 B/token) |
| `W_i (gml)` | layer | 18.40 GiB |
| `dW_i (gml)` | layer/step | 18.40 GiB |
| `O_i (gml)` | layer | 36.80 GiB |
| `A (gml)` | layer × round | 7.62 GiB (121.89 KiB/token) |
| `M (gml)` | layer × round | 517.00 MiB (8.08 KiB/token) |
| `W_head` | run | 1.77 GiB |
...
|---|---|---|
| W (all weights, incl. embed/head) | 80 | 1,384.66 GiB |
| dW (all gradients, per step) | 99 | 1,394.16 GiB |
| O (all optimizer state) | 80 | 2,769.31 GiB |
| A (all saved activations, one round) | 78 | 589.62 GiB (9.21 MiB/token) |
| M (all metadata, one round) | 78 | 10.87 GiB (173.86 KiB/token) |
...
**`A_.._6` saved context** — 7.62 GiB = **121.89 KiB/token** (per (step, round))
...
**`M_.._6` metadata** — 517.00 MiB = **8.08 KiB/token** (never recomputed)
...
- inputs: `y_0_0_2` (768.00 MiB), `W_3` (18.38 GiB), `AuxTemp_0_0_2` (512.00 MiB), `current_round_0_0` (4 B), `Aux_3` (3.00 KiB)
- outputs: `y_0_0_3` (768.00 MiB), `A_0_0_3` (7.62 GiB), `AuxTemp_0_0_3` (5.00 MiB)
- mutates: `Aux_3`
- stages (name — emitted ctx fields):
    0. `attn_norm` — rstd_attn
    1. `mla_q` — q_a, rstd_qa
...
- inputs: `y_0_0_5` (768.00 MiB), `W_6` (18.40 GiB), `current_round_0_0` (4 B), `Aux_6` (3.00 KiB)
- outputs: `y_0_0_6` (768.00 MiB), `A_0_0_6` (7.62 GiB), `AuxTemp_0_0_6` (517.00 MiB)
- mutates: `Aux_6`
- stages (name — emitted ctx fields):
    0. `attn_norm` — rstd_attn
    1. `mla_q` — q_a, rstd_qa
...
- inputs: `dy_0_0_77` (768.00 MiB), `A_0_0_77` (7.62 GiB), `y_0_0_76` (768.00 MiB), `W_77` (18.38 GiB), `AuxTemp_0_0_77` (5.00 MiB), `AuxTemp_0_0_74` (517.00 MiB), `Aux_77` (3.00 KiB)
- outputs: `dy_0_0_76` (768.00 MiB), `dW_0_77` (18.38 GiB), `dAuxTemp_0_0_74` (512.00 MiB)
- mutates: `W_77`
- kernel calls:
    0. `rmsnorm_apply`
...
- inputs: `W_77` (18.38 GiB), `dW_0_77` (18.38 GiB), `O_77` (36.76 GiB)
- outputs: —
- mutates: `W_77`, `O_77`
- kernel calls:
    0. `adamw_step ×14`
...
- inputs: `dy_0_0_74` (768.00 MiB), `A_0_0_74` (7.62 GiB), `y_0_0_73` (768.00 MiB), `W_74` (18.40 GiB), `AuxTemp_0_0_74` (517.00 MiB), `dAuxTemp_0_0_74` (512.00 MiB), `Aux_74` (3.00 KiB)
- outputs: `dy_0_0_73` (768.00 MiB), `dW_0_74` (18.40 GiB)
- mutates: `W_74`
- kernel calls:
    0. `rmsnorm_apply`
    1. `moe_dispatch_fwd ×2`
...
- inputs: `dy_0_0_2` (768.00 MiB), `A_0_0_2` (6.09 GiB), `y_0_0_1` (768.00 MiB), `W_2` (765.03 MiB), `AuxTemp_0_0_2` (512.00 MiB), `dAuxTemp_0_0_2` (512.00 MiB)
