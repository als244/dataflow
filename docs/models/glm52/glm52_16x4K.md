# glm52 / `glm52` @ 16x4K: tasks, objects, kernels

GENERATED from `ShapedGlm52Config.glm52()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_page.py --preset glm52 --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).

Layer kinds (78 layers): `gdl gdl gdl gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf gml gmf gmf gmf`
...
| object | scope | bytes |
|---|---|---|
| `W_i (gdl)` | layer | 802,190,848 |
| `dW_i (gdl)` | layer/step | 802,190,848 |
| `O_i (gdl)` | layer | 1,604,381,696 |
| `A (gdl)` | layer × round | 6,535,774,208 (99,728.0/token) |
| `M (gdl)` | layer × round | 536,870,912 (8,192.0/token) |
| `W_i (gmf)` | layer | 19,736,066,048 |
| `dW_i (gmf)` | layer/step | 19,736,066,048 |
| `O_i (gmf)` | layer | 39,472,132,096 |
| `A (gmf)` | layer × round | 8,179,941,376 (124,816.0/token) |
| `M (gmf)` | layer × round | 5,244,160 (80.0/token) |
| `W_i (gml)` | layer | 19,755,203,072 |
| `dW_i (gml)` | layer/step | 19,755,203,072 |
| `O_i (gml)` | layer | 39,510,406,144 |
| `A (gml)` | layer × round | 8,179,941,376 (124,816.0/token) |
| `M (gml)` | layer × round | 542,115,072 (8,272.0/token) |
...
|---|---|---|
| W (all weights, incl. embed/head) | 80 | 1,486,762,335,744 |
| dW (all gradients, incl. metadata grads, per step) | 99 | 1,496,962,883,072 |
| O (all optimizer state) | 80 | 2,973,524,671,488 |
| A (all saved contexts, one round) | 78 | 633,102,925,824 (9,660,384.0/token) |
| M (all metadata, one round) | 78 | 11,667,601,152 (178,033.5/token) |
...
**`W_3` weights** — 19,736,066,048 bytes
...
### kind `gml` (e.g. layer 6)

**`W_6` weights** — 19,755,203,072 bytes
...
**`A_.._6` saved context** — 8,179,941,376 bytes = **124,816.0 bytes/token** (per (step, round))
...
**`M_.._6` metadata** — 542,115,072 bytes = **8,272.0 bytes/token** (never recomputed)
...
- inputs: `y_0_0_2` (805,306,368B), `W_3` (19,736,066,048B), `M_0_0_2` (536,870,912B)
- outputs: `y_0_0_3` (805,306,368B), `A_0_0_3` (8,179,941,376B), `M_0_0_3` (5,244,160B)
- mutates: —
- stages (name — emitted ctx fields):
    0. `attn_norm` — rstd_attn
    1. `mla_q` — q_a, rstd_qa
...
- example task: `block_fwd_0_0_6`
- inputs: `y_0_0_5` (805,306,368B), `W_6` (19,755,203,072B)
- outputs: `y_0_0_6` (805,306,368B), `A_0_0_6` (8,179,941,376B), `M_0_0_6` (542,115,072B)
- mutates: —
- stages (name — emitted ctx fields):
    0. `attn_norm` — rstd_attn
    1. `mla_q` — q_a, rstd_qa
...
- inputs: `dy_0_0_77` (805,306,368B), `A_0_0_77` (8,179,941,376B), `y_0_0_76` (805,306,368B), `W_77` (19,736,066,048B), `M_0_0_77` (5,244,160B), `M_0_0_74` (542,115,072B)
- outputs: `dy_0_0_76` (805,306,368B), `dW_0_77` (19,736,066,048B), `dM_0_0_74` (536,870,912B)
- mutates: —
...
- inputs: `W_77` (19,736,066,048B), `dW_0_77` (19,736,066,048B), `O_77` (39,472,132,096B)
- outputs: —
- mutates: `W_77`, `O_77`
...
- example task: `block_bwd_0_0_74`
- inputs: `dy_0_0_74` (805,306,368B), `A_0_0_74` (8,179,941,376B), `y_0_0_73` (805,306,368B), `W_74` (19,755,203,072B), `M_0_0_74` (542,115,072B), `dM_0_0_74` (536,870,912B)
- outputs: `dy_0_0_73` (805,306,368B), `dW_0_74` (19,755,203,072B)
- mutates: —
...
- inputs: `dy_0_0_2` (805,306,368B), `A_0_0_2` (6,535,774,208B), `y_0_0_1` (805,306,368B), `W_2` (802,190,848B), `M_0_0_2` (536,870,912B), `dM_0_0_2` (536,870,912B)
