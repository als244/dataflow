# glm52 / `glm52_mini_warmup` @ 16x4K: tasks, objects, kernels

GENERATED from `ShapedGlm52Config.glm52_mini_warmup()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset glm52_mini_warmup --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
| `O_i (gdl)` | layer | 1.63 MiB |
| `A (gdl)` | layer × round | 104.75 MiB (1.64 KiB/token) |
| `W_i (gml)` | layer | 1.52 GiB |
| `dW_i (gml)` | layer/step | 1.52 GiB |
| `O_i (gml)` | layer | 1.63 MiB |
| `A (gml)` | layer × round | 104.75 MiB (1.64 KiB/token) |
| `M (gml)` | layer × round | 5.00 MiB (80.0 B/token) |
| `W_i (gmf)` | layer | 1.52 GiB |
| `dW_i (gmf)` | layer/step | 1.52 GiB |
| `O_i (gmf)` | layer | 0 B |
| `A (gmf)` | layer × round | 104.75 MiB (1.64 KiB/token) |
...
| dW (all gradients, per step) | 22 | 16.00 GiB |
| O (all optimizer state) | 6 | 9.76 MiB |
...
**`A_.._3` saved context** — 104.75 MiB = **1.64 KiB/token** (per (step, round))
...
### `gmf_fwd` — `Glm52WarmupMfBlockFwd`

- example task: `block_fwd_0_0_3`
- inputs: `y_0_0_2` (256.00 MiB), `W_3` (1.52 GiB), `AuxTemp_0_0_2` (5.00 MiB), `current_round_0_0` (4 B), `Aux_3` (1.50 KiB)
- outputs: `y_0_0_3` (256.00 MiB), `A_0_0_3` (104.75 MiB), `AuxTemp_0_0_3` (5.00 MiB)
- mutates: `Aux_3`
- stages (name — emitted ctx fields):
    0. `attn_norm` — rstd_attn
    1. `mla_q` — q_a, rstd_qa
...
- inputs: `A_0_0_17` (104.75 MiB), `y_0_0_16` (256.00 MiB), `W_17` (1.52 GiB), `AuxTemp_0_0_17` (5.00 MiB), `AuxTemp_0_0_14` (5.00 MiB)
- outputs: `dAuxTemp_0_0_14` (1.00 GiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_apply`
...
- inputs: `A_0_0_14` (104.75 MiB), `y_0_0_13` (256.00 MiB), `W_14` (1.52 GiB), `AuxTemp_0_0_14` (5.00 MiB), `dAuxTemp_0_0_14` (1.00 GiB)
...
- example task: `optimizer_0_14`
- inputs: `W_14` (1.52 GiB), `dW_0_14` (832.50 KiB), `O_14` (1.63 MiB)
- outputs: —
- mutates: `W_14`, `O_14`
- kernel calls:
    0. `adamw_step ×14`
