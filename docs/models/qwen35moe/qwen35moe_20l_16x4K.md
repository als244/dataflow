# qwen35moe / `qwen35moe_20l` @ 16x4K: tasks, objects, kernels

GENERATED from `ShapedQwen35MoeConfig.qwen35moe_20l()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset qwen35moe_20l --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).

Layer kinds (20 layers): `lin lin lin full lin lin lin full lin lin lin full lin lin lin full lin lin lin full`
...
|---|---|---|
| W (all weights, incl. embed/head) | 22 | 33.23 GiB |
| dW (all gradients, per step) | 22 | 33.23 GiB |
| O (all optimizer state) | 22 | 66.45 GiB |
| A (all saved activations, one round) | 20 | 70.41 GiB (1.10 MiB/token) |
| M (all metadata, one round) | 20 | 100.02 MiB (1.56 KiB/token) |
...
- inputs: `Aux_0` (3.00 KiB), `Aux_1` (3.00 KiB), `Aux_2` (3.00 KiB), `Aux_3` (3.00 KiB), `Aux_4` (3.00 KiB), `Aux_5` (3.00 KiB), `Aux_6` (3.00 KiB), `Aux_7` (3.00 KiB), `Aux_8` (3.00 KiB), `Aux_9` (3.00 KiB), `Aux_10` (3.00 KiB), `Aux_11` (3.00 KiB), `Aux_12` (3.00 KiB), `Aux_13` (3.00 KiB), `Aux_14` (3.00 KiB), `Aux_15` (3.00 KiB), `Aux_16` (3.00 KiB), `Aux_17` (3.00 KiB), `Aux_18` (3.00 KiB), `Aux_19` (3.00 KiB)
- outputs: `current_round_0_0` (4 B)
- mutates: `Aux_0`, `Aux_1`, `Aux_2`, `Aux_3`, `Aux_4`, `Aux_5`, `Aux_6`, `Aux_7`, `Aux_8`, `Aux_9`, `Aux_10`, `Aux_11`, `Aux_12`, `Aux_13`, `Aux_14`, `Aux_15`, `Aux_16`, `Aux_17`, `Aux_18`, `Aux_19`
...
- inputs: `y_0_0_19` (256.00 MiB), `targets_0_0` (256.00 KiB), `W_head` (970.00 MiB)
- outputs: `dy_0_0_19` (256.00 MiB), `loss_0_0` (4 B), `dW_head_0` (970.00 MiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_fwd`
    1. `mm`
...
- example task: `block_bwd_0_0_19`
- inputs: `dy_0_0_19` (256.00 MiB), `A_0_0_19` (3.04 GiB), `y_0_0_18` (256.00 MiB), `W_19` (1.56 GiB), `AuxTemp_0_0_19` (5.00 MiB), `Aux_19` (3.00 KiB)
- outputs: `dy_0_0_18` (256.00 MiB), `dW_0_19` (1.56 GiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_apply`
...
- example task: `optimizer_0_19`
- inputs: `W_19` (1.56 GiB), `dW_0_19` (1.56 GiB), `O_19` (3.12 GiB)
- outputs: —
- mutates: `W_19`, `O_19`
- kernel calls:
    0. `adamw_step ×14`
...
- example task: `block_bwd_0_0_18`
- inputs: `dy_0_0_18` (256.00 MiB), `A_0_0_18` (3.68 GiB), `y_0_0_17` (256.00 MiB), `W_18` (1.57 GiB), `AuxTemp_0_0_18` (5.00 MiB), `Aux_18` (3.00 KiB)
- outputs: `dy_0_0_17` (256.00 MiB), `dW_0_18` (1.57 GiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_apply`
    1. `moe_dispatch_fwd ×2`
