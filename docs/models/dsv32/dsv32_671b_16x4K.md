...
GENERATED from `ShapedDsv32Config.dsv32_671b()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset dsv32_671b --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
| object | scope | size |
|---|---|---|
| `W_i (dense)` | layer | 1.11 GiB |
| `dW_i (dense)` | layer/step | 1.11 GiB |
| `O_i (dense)` | layer | 2.23 GiB |
| `A (dense)` | layer × round | 7.67 GiB (122.64 KiB/token) |
| `M (dense)` | layer × round | 512.00 MiB (8.00 KiB/token) |
| `W_i (moe)` | layer | 21.46 GiB |
| `dW_i (moe)` | layer/step | 21.46 GiB |
| `O_i (moe)` | layer | 42.92 GiB |
...
|---|---|---|
| W (all weights, incl. embed/head) | 63 | 1,251.52 GiB |
| dW (all gradients, per step) | 63 | 1,251.52 GiB |
| O (all optimizer state) | 63 | 2,503.04 GiB |
| A (all saved activations, one round) | 61 | 469.38 GiB (7.33 MiB/token) |
| M (all metadata, one round) | 61 | 30.78 GiB (492.53 KiB/token) |
...
| `w_idx_q` | bf16 | (1536, 8192) | 24.00 MiB |
| `w_idx_k` | bf16 | (7168, 128) | 1.75 MiB |
| `idx_k_ln_w` | bf16 | (128,) | 256 B |
| `idx_k_ln_b` | bf16 | (128,) | 256 B |
| `w_idx_w` | fp32 | (7168, 64) | 1.75 MiB |
...
- inputs: `y_embed_0_0` (896.00 MiB), `W_0` (1.11 GiB)
- outputs: `y_0_0_0` (896.00 MiB), `A_0_0_0` (7.67 GiB), `AuxTemp_0_0_0` (512.00 MiB)
- mutates: —
...
- inputs: `y_0_0_2` (896.00 MiB), `W_3` (21.46 GiB), `current_round_0_0` (4 B), `Aux_3` (3.00 KiB)
- outputs: `y_0_0_3` (896.00 MiB), `A_0_0_3` (7.70 GiB), `AuxTemp_0_0_3` (517.00 MiB)
- mutates: `Aux_3`
- stages (name — emitted ctx fields):
    0. `attn_norm` — rstd_attn
    1. `mla_q` — q_a, rstd_qa
...
- inputs: `dy_0_0_60` (896.00 MiB), `A_0_0_60` (7.70 GiB), `y_0_0_59` (896.00 MiB), `W_60` (21.46 GiB), `AuxTemp_0_0_60` (517.00 MiB), `Aux_60` (3.00 KiB)
- outputs: `dy_0_0_59` (896.00 MiB), `dW_0_60` (21.46 GiB)
- mutates: `W_60`
- kernel calls:
    0. `rmsnorm_apply`
...
- inputs: `W_60` (21.46 GiB), `dW_0_60` (21.46 GiB), `O_60` (42.92 GiB)
- outputs: —
- mutates: `W_60`, `O_60`
- kernel calls:
    0. `adamw_step ×19`
...
- inputs: `dy_0_0_2` (896.00 MiB), `A_0_0_2` (7.67 GiB), `y_0_0_1` (896.00 MiB), `W_2` (1.11 GiB), `AuxTemp_0_0_2` (512.00 MiB)
- outputs: `dy_0_0_1` (896.00 MiB), `dW_0_2` (1.11 GiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_apply`
    1. `swiglu_fwd_out`
