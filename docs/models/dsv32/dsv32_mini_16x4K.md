...
GENERATED from `ShapedDsv32Config.dsv32_mini()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset dsv32_mini --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
| `O_i (dense)` | layer | 212.89 MiB |
| `A (dense)` | layer × round | 2.48 GiB (39.64 KiB/token) |
| `M (dense)` | layer × round | 256.00 MiB (4.00 KiB/token) |
| `W_i (moe)` | layer | 1.52 GiB |
| `dW_i (moe)` | layer/step | 1.52 GiB |
| `O_i (moe)` | layer | 3.04 GiB |
| `A (moe)` | layer × round | 2.74 GiB (43.89 KiB/token) |
| `M (moe)` | layer × round | 261.00 MiB (4.08 KiB/token) |
...
| dW (all gradients, per step) | 20 | 25.55 GiB |
| O (all optimizer state) | 20 | 51.11 GiB |
| A (all saved activations, one round) | 18 | 48.85 GiB (781.53 KiB/token) |
| M (all metadata, one round) | 18 | 4.58 GiB (73.25 KiB/token) |
...
- inputs: `dy_0_0_17` (256.00 MiB), `A_0_0_17` (2.74 GiB), `y_0_0_16` (256.00 MiB), `W_17` (1.52 GiB), `AuxTemp_0_0_17` (261.00 MiB), `Aux_17` (1.50 KiB)
- outputs: `dy_0_0_16` (256.00 MiB), `dW_0_17` (1.52 GiB)
- mutates: `W_17`
- kernel calls:
    0. `rmsnorm_apply`
