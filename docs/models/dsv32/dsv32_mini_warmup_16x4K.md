...
GENERATED from `ShapedDsv32Config.dsv32_mini_warmup()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_page.py --preset dsv32_mini_warmup --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
- outputs: `dy_0_0_16` (256.00 MiB), `dW_0_17` (832.50 KiB)
- mutates: —
- kernel calls:
    0. `rmsnorm_apply`
