...
GENERATED from `ShapedQwen35Config.tiny()` at run shape microbatch 16 × seq 4096 — regenerate with `python tools/gen_model_docs/gen_model_page.py --preset tiny --microbatch 16 --seq-len 4096`. All presets: [builtin_models.md](../../builtin_models.md); task-kind fleet index: [task_kinds.md](../../task_kinds.md).
...
|---|---|---|
| W (all weights, incl. embed/head) | 6 | 4.77 MiB |
| dW (all gradients, per step) | 6 | 4.77 MiB |
| O (all optimizer state) | 6 | 9.55 MiB |
