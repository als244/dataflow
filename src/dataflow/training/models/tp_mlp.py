...
dataflow.training.models.tp_mlp``. Standalone runs (no group handle
...
def tp_weight_layout(dims: TpMlpDims):
    from dataflow.tasks.layouts import PackedLayout
...
class TpMlpFwd:
    ...
    def launch(self, ctx) -> None:
        ...
        from dataflow.tasks.interop import external_stream, torch_view
...
def register() -> None:
    from dataflow.training.families import _FAMILIES, register_family
