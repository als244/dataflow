...
import { MeasuredRunImport, MeasuredRunResults } from "./components/MeasuredRunPanel";
import type { EventLog, MeasuredRun } from "./types";
import "./App.css";
...
export default function App() {
  ...
  const [measuredRun, setMeasuredRun] = useState<MeasuredRun | null>(null);
    ...
    <div className="app">
      ...
      <div className="workspace-shell">
        <aside className="workspace-left">
          ...
          <MeasuredRunImport run={measuredRun} onLoad={setMeasuredRun} />
        ...
        <main className="workspace-right">
          {measuredRun && <MeasuredRunResults run={measuredRun} />}
