...
from ...blocks.modules.moe.stages import MOE_STAGES, MoEAuxTempState, MoEProfileFill, moe_mlp_tail_bwd
    ...
    table = {
        ...
        "optimizer_block": AdamWStep(
            ...
            resolve_layout=lambda d, task, size: (
                olmoe_weight_layout(d, layer=AdamWStep.parse_layer(task)), None,
            ),
        ),
