...
VERBATIM (subclassed from qwen35/blocks.py — the dense-tail template split's payoff),
...
from ...blocks.modules.moe.stages import MOE_SHARED_STAGES, MoEAuxTempState, MoEProfileFill, moe_mlp_tail_bwd
from ..qwen35.blocks import (
    Qwen35AttnBlockBwd,
    Qwen35AttnBlockFwd,
    Qwen35LinBlockBwd,
    Qwen35LinBlockFwd,
