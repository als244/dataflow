...
from dataflow_training.blocks.base_blocks import AdamWHyper  # noqa: F401
...
def check_block_backward(dims, *, family=None, seed: int = 0, tol: float = 3e-2) -> CheckReport:
    ...
    if family is None:
        from dataflow_training.model_families.families import family as _fam
    ...
    from dataflow_training.testing.block_forms import BLOCK_FORWARDS
